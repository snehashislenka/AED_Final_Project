 ...
 * @author slenk
 */
public class UpdateBusBooking extends javax.swing.JPanel {

    /**
     * Creates new form UpdateBusBooking
     */
    
    private String selectedStatus;
    private int selectedBookingId;
    BusAdminDashboard busAdminDash;
    
    public UpdateBusBooking() {
        initComponents();
    ...
    public UpdateBusBooking(BusAdminDashboard busAdminDash) {
        initComponents();
        this.busAdminDash = busAdminDash;
        String[] statusArr = {"SELECT A STATUS", "BOOKED", 
            "CANCELLED", "CHECKED_IN"}; 
        flightBookingStatusCombo.setModel(new javax.swing.DefaultComboBoxModel<>(statusArr));
    ...
    public void populateTable() {
        ArrayList<BusBookings> flightBookingsList = 
                MySQLUtil.getAllBusBookings();
        
        DefaultTableModel model = (DefaultTableModel) 
                tableBusBookingDetails.getModel();
        
        model.setRowCount(0);
        
        for(BusBookings bookings: flightBookingsList) {
    ...
    private void initComponents() {
        ...
        tableBusBookingDetails = new javax.swing.JTable();
        ...
        tableBusBookingDetails.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tableBusBookingDetails.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableBusBookingDetailsMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tableBusBookingDetails);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(flightBookingStatusCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnUpdateStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateStatusActionPerformed
        ...
        if(tableBusBookingDetails.getSelectedRow() < 0) {
    ...
    private void tableBusBookingDetailsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableBusBookingDetailsMouseClicked
        int selectedRow = tableBusBookingDetails.getSelectedRow();

        this.selectedBookingId = Integer.parseInt(tableBusBookingDetails.getValueAt(
            selectedRow, 0).toString());

    }//GEN-LAST:event_tableBusBookingDetailsMouseClicked

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.busAdminDash.switchHome();
    ...
    private javax.swing.JTable tableBusBookingDetails;
